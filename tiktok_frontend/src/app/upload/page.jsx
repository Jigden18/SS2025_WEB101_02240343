export default function UploadPage() {
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      <div className="flex">
        <div className="w-[368px] border-dashed border-2 border-gray-300 rounded-lg p-8 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-xs text-gray-400 mb-2">Up to 10 minutes</p>
          <p className="text-sm text-gray-500 mb-2">Or drag and drop a file</p>
          <p className="text-xs text-gray-400 mb-2">MP4 or WebM</p>
          <p className="text-xs text-gray-400 mb-4">Less than 2 GB</p>
          <button className="mt-4 bg-red-500 text-white py-2 px-8 rounded-md">
            Select file
          </button>
        </div>
